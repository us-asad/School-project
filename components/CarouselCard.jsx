...
export default function CarouselCard({ imageUrl, alt, title, description, buttonName, buttonUrl }) {
	return (
		<div className="h-[210px] sm:h-[360px] md:h-[440px] lg:h-[540px] xl:h-[600px]">
			...
			<Image
				...
				quality={100}
			/>
			<div className="absolute top-[20%] sm:top-[40%] md:left-32 md:right-32 w-full md:px-0 px-16 md:w-auto flex flex-col md:items-start items-center z-20 text-white">
