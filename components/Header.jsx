...
export default function Header() {
	...
	const navbarClassNames = `flex justify-between items-center transition duration-100 w-full py-8 px-6 sm:px-20 fixed top-0 left-0 z-30 ${scrollY > 30 ? "bg-[#0155bf] border-b-2" : ""}`;
