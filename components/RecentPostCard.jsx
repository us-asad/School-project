...
export default function RecentPostCard(props) {
  ...
  return (
    <section className="h-[616px] bg-[#f8faff] w-[350px] text-black rounded mx-5 sm:mx-0" id="recent-posts">
      ...
      <div className="flex flex-col justify-between pt-2 sm:pt-8 px-7 pb-9 h-[300px]">
        <div>
          ...
          <h4 className="mt-5 mb-3.5 text-xl font-bold custonLineClamp1">{title}</h4>
